      ...
      items: [
        {
          ...
          label: "Personal Info",
          link: "/profile",
          value: mistri?.mistriname || "Not set",
        },
        {
          icon: Shield,
              ...
              {group.items.map((item, itemIndex) => (
                <div
                  ...
                  {item.isToggle ? (
                    ...
                    <Link
                      to={item.link}
                      className="flex items-center text-gray-600 truncate text-ellipsis">
                      {item.value && <span className="mr-2 text-sm text-gray-500 w-24 truncate ">{item.value}</span>}
