...
const MistriRegister = () => {
  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center dark:bg-black dark:text-white text-black bg-gray-50">
      <ToastContainer />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {requiredFields.map((field, index) => (
                <div key={index} className="space-y-2">
                  <label htmlFor={field.name} className="block text-sm font-medium dark:text-white text-gray-700">
                    {field.label}
                  </label>
            ...
            <div className="space-y-6 mt-6">
              <div>
                ...
                <div
                  ...
                  className={`cursor-pointer border-2 border-dashed ${fieldErrors.idProof ? "border-red-500" : displayIdProofImage ? "border-gray-300" : "border-gray-300 hover:border-gray-400"} dark:border-gray-700 rounded-xl p-4 transition-all duration-200 flex flex-col items-center justify-center h-48`}
                >
                  {displayIdProofImage ? (
                    <img
              ...
              <div>
                ...
                <div
                  ...
                  className={`cursor-pointer border-2 border-dashed ${fieldErrors.profileImage ? "border-red-500" : displayProfileImage ? "border-gray-300" : "border-gray-300 hover:border-gray-400"} dark:border-gray-700 rounded-xl p-4 transition-all duration-200 flex flex-col items-center justify-center h-48`}
                >
                  {displayProfileImage ? (
                    <img
